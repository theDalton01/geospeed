...
import { createSpeedTestInfoModal } from "./modal.js";
...
export function createTestPage() {
  ...
  infoImg.addEventListener("click", () => {
    document.body.appendChild(createSpeedTestInfoModal());
  });
  ...
  pingText.style.color = "var(--primary-color)";
  ...
  jitText.style.color = "var(--primary-color)";
